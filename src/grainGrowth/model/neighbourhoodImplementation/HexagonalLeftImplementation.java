...
public class HexagonalLeftImplementation implements NeighbourhoodMethodImplementation{
    private GrainsContainer grainsContainer;

    public HexagonalLeftImplementation(GrainsContainer grainsContainer)
    {
