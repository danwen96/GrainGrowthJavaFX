...
public class HexagonalRightImplementationPeriodically implements NeighbourhoodMethodImplementation {
    private GrainsContainer grainsContainer;

    public HexagonalRightImplementationPeriodically(GrainsContainer grainsContainer)
    {
