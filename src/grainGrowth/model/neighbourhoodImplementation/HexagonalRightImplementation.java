...
public class HexagonalRightImplementation implements NeighbourhoodMethodImplementation {
    private GrainsContainer grainsContainer;

    public HexagonalRightImplementation(GrainsContainer grainsContainer)
    {
