...
public class PentagonalRandomImplementation implements NeighbourhoodMethodImplementation{
    private GrainsContainer grainsContainer;

    public PentagonalRandomImplementation(GrainsContainer grainsContainer)
    {
