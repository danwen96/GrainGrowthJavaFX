...
/**
 * Simulating the Von Neumann neighbourhood grain growth with periodical boundary conditions
 */
public class VonNeumannMethodImplementationPeriodically implements NeighbourhoodMethodImplementation {
    private GrainsContainer grainsContainer;

    public VonNeumannMethodImplementationPeriodically(GrainsContainer grainsContainer)
    {
