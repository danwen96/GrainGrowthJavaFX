...
public class HexagonalRandomImplementation implements NeighbourhoodMethodImplementation {
    private GrainsContainer grainsContainer;

    public HexagonalRandomImplementation(GrainsContainer grainsContainer) {
