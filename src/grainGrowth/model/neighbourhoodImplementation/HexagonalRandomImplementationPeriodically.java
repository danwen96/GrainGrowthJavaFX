...
public class HexagonalRandomImplementationPeriodically implements NeighbourhoodMethodImplementation {
    private GrainsContainer grainsContainer;

    public HexagonalRandomImplementationPeriodically(GrainsContainer grainsContainer) {
            ...
            for (int j = 0; j < (grainsContainer.getnY()); j++)
            {
                ...
                if(random.nextBoolean()) {
                    ...
                    if (grainsContainer.getTheCellState(indRight, j) > 0) {
                        values[3] = grainsContainer.getTheCellState(indRight, j);
                    ...
                    if (grainsContainer.getTheCellState(indRight, indDown) > 0) {
                        values[5] = grainsContainer.getTheCellState(indRight, indDown);
                ...
                else
                {
                    ...
                    {
                        values[0] = grainsContainer.getTheCellState(indRight,indUp);
