...
public class HexagonalLeftImplementationPeriodically implements NeighbourhoodMethodImplementation{
    private GrainsContainer grainsContainer;

    public HexagonalLeftImplementationPeriodically(GrainsContainer grainsContainer)
    {
