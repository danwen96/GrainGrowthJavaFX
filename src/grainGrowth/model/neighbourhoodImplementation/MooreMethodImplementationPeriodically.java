...
/**
 * Simulating the Moore neighbourhood grain growth with periodical boundary conditions
 */
public class MooreMethodImplementationPeriodically implements NeighbourhoodMethodImplementation{
    private GrainsContainer grainsContainer;

    public MooreMethodImplementationPeriodically(GrainsContainer grainsContainer)
    {
